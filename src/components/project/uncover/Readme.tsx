        ...
        <Section>
          ...
          <Content>
            ...
            <li>
              ...
              응답코드에 대한 지식을 익힐 수 있었습니다.
            </li>
            <h2>믹싱 페이지 구현</h2>
            <li>
              음원과 영상의 핏이 적합한지 대조해 볼 수 있는 믹싱페이지 구현을 맡았습니다. 해당 페이지 구현을 위해서는
              비디오와 오디오를 동시에 조작해야했고, 그러기 위해선 DOM 조작이 필요했습니다. 이전 토이프로젝트에서는 쿼리
              셀렉터를 통해 DOM을 조작했지만, 리액트 공식문서를 살펴보니 리액트는 선언형 프로그래밍을 권장하는데 쿼리
              셀렉터는 명령형 프로그래밍에 더 가깝기 때문에 useRef를 사용하여 이러한 고민을 해결했습니다.
            </li>
            <h2>반응형 웹 레이아웃 구현</h2>
            <li>
