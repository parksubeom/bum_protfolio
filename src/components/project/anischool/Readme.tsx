        ...
        <Container>
          <Section>
            ...
            <Content>
              <p>
                <strong>
                  자신의 개성이 중요해진 요즘, 본인의 프로필을 업로드 해야 하지만 얼굴을 올리기 싫은 사람들을 위해
                  귀여운 동물 이미지를 만들어주는 서비스입니다.
                </strong>
              </p>
              <p>
          ...
          <Section>
            ...
            <Content>
              <h2>랜덤 이미지 생성</h2>
              <li>
                랜덤버튼 클릭 시, (Math.random() * 해당파츠의 종류 갯수) 의 결과값을 상태에 저장하고, 해당 상태를
                이미지를 보여주는 컴포넌트에 props로 넘겨줍니다. 랜덤버튼 컴포넌트에서 해당 상태를 전달받으면 해당
                파츠의 이미지를 폴더에서 상태와 같은 숫자의 이미지를 불러오는 식으로 구현했습니다.
              </li>
              <li>
              ...
              <h2>라이트하우스 최적화</h2>
              <li>
                프로젝트를 마무리하고 라이트 하우스를 통해 성능을 체크 했을 땐, SEO 를 제외한 모든 부분의 성능이
                기대보다 낮았습니다.
              </li>
              <li>
                이를 최적화 하기 위해 크게 두가지의 개선방안을 생각했습니다. 첫번째로 코드에서의 최적화, 두번째로
                리소스의 최적화 이렇게 두가지를 생각했습니다.
              </li>
              <li>
